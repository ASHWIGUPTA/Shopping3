<%-- 
    Document   : single
    Created on : Jun 14, 2017, 1:40:07 PM
    Author     : puneet gupta
--%>
...
<div class="banner-top">
	<div class="container">
		<h1>Single</h1>
		<em></em>
		<h2><a href="index-2.html">Home</a><label>/</label>Single</a></h2>
	</div>
</div>

<%
    HttpSession session2 = request.getSession(false);
    ProductDTO pd = (ProductDTO)session2.getAttribute("product");
%>
<!---728x90--->
<div class="single">
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
                              <li data-thumb="images/<%=pd.getImg_path()%>">
			        <div class="thumb-image"> <img src="images/<%=pd.getImg_path()%>" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
...
<!--				<p class="in-para"> There are many variations of passages of Lorem Ipsum.</p>-->
			    <div class="price_single">
				  <span class="reducedfrom item_price">Rs.<%=pd.getPrice()%></span>
				 <a href="#">click for offer</a>
				 <div class="clearfix"></div>
				</div>
				<h4 class="quick">Quick Overview:</h4>
				<p class="quick_desc"><%=pd.getDescr()%></p>
...
<!-- Mirrored from p.w3layouts.com/demos/shopin/web/single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 19:30:10 GMT -->
</html>