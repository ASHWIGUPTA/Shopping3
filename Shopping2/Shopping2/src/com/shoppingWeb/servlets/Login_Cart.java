...
System.out.println("System enter the Login Cart");
if(session.getAttribute("UserId")==null && request.getParameter("productID")!=null){                   // session Attribute Added
	System.out.println("System enter the Login Cart1121121");
	
	HashSet list=new HashSet<>();
list.add(request.getParameter("productID"));
session.setAttribute("ProductNO", list);	
Iterator it=list.iterator();
while(it.hasNext()){
	System.out.println("Product no"+it.next());
}
