...
if(session.getAttribute("Lis")!=null){            //empty cart add
list=new HashSet();
}

System.out.println("Enter the Index11111111111111111111111");
	if(session.getAttribute("UserId")==null && session.getAttribute("ProductNo")!=null){                   // session Attribute Added
       System.out.println("Enter the Index");
		...
		while(it.hasNext()){
			System.out.println("index pid "+it.next());
		}
		tempCartAddress="CartProduct";
		tempAddress="index.jsp";
			
	}
	else if(session.getAttribute("UserId")!=null){                                                     //Login Attribute Added
						...
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="MenuController?menu=men_vests">Vests</a></li>
					...
					<div class="pro-img">
						...
						<div class="women-top">
							...
							<div class="img item_add">
								<a href="Login_Cart?productID=<%=resultSet.getString("product_id") %>"><img src="images/ca.png" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
